...
```
[定时器T0的计算要去看这里](#定时器0初值计算)  
单片机是根据时钟周期来计数的，而时钟周期等于振荡周期，所以我们知道晶振频率就可以算出我们需要的数据。  
[关于 机器周期 时钟周期 振荡周期 是什么可以去看这个](https://blog.csdn.net/weixin_42341666/article/details/89603205)  
